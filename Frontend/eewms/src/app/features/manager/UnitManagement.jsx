            ...
            <div className="flex items-center justify-between px-2 py-2 text-lg font-semibold text-left text-gray-900 bg-white rtl:text-right dark:text-white dark:bg-gray-800">
              <div className="flex flex-col">
                ...
                <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                  Thông tin đơn vị tính thiết bị điện
                </p>
              </div>
              <button
                className="flex items-center w-[15%] h-10 gap-2 px-4 py-2 text-base text-white bg-blue-500 outline-none"
          ...
          {listUnits?.content?.map((item, index) => {
            return (
              ...
              >
                ...
                <th
                  scope="row"
                  className="flex justify-start px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                >
                  {item?.name}
                </th>
                <td className="px-6 py-4 ">
                  <a
                    className="mr-4 font-medium text-blue-600 cursor-pointer dark:text-blue-500 hover:underline"
                ...
                <td className="px-6 py-4 ">
                  <a
                    className="font-medium cursor-pointer text-red dark:text-blue-500 hover:underline"
